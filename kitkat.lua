...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Kitkat.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KT", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Kitkat -X kill
screen -S Kitkat ./Kitkat
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKitkatW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "tsss2018")
...
local Kitkat_Msg = ''  
if msgs < 100 then 
Kitkat_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Kitkat_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Kitkat_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Kitkat_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Kitkat_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Kitkat_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Kitkat_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Kitkat_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Kitkat_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Kitkat_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Kitkat_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Kitkat_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Kitkat_Msg = 'رب التفاعل'  
end 
return Kitkat_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKitkat(msg,data) -- بداية العمل
if msg then
...
SourceKitkatr = '✟︙اهلا عزيزي\n✟︙انا بوت اسمي '..Namebot..'\n✟︙اختصاصي حمايه الكروبات\n✟︙من تكرار والسبام والتوجيه والخ…\n✟︙لتفعيلي اتبع الاخطوات…↓\n✟︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[✟︙[قناة سورس البوت](http://t.me/tsss2018)'
end 
send(msg.chat_id_, msg.id_, SourceKitkatr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevKitkatW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKitkatW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Kitkat_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل✟︙' and DevKitkatW(msg) then  
...
if text == 'تعطيل التواصل✟︙' and DevKitkatW(msg) then  
...
if text == 'تفعيل البوت الخدمي✟︙' and DevKitkatW(msg) then  
...
if text == 'تعطيل البوت الخدمي✟︙' and DevKitkatW(msg) then  
...
if text == 'ضع كليشه ستارت✟︙' and DevKitkatW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'✟︙ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت✟︙' and DevKitkatW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'✟︙تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر✟︙' and DevKitkatW(msg) then 
...
if text == 'تحديث السورس✟︙' and DevKitkatW(msg) then 
os.execute('rm -rf Kitkat.lua')
os.execute('wget https://raw.githubusercontent.com/KitkatTEAM/Kitkat/main/Kitkat.lua')
send(msg.chat_id_, msg.id_,'✟︙تم تحديث السورس \n✟︙لديك اخر اصدار لسورس براند\n✟︙الاصدار » { 1.5v}')
dofile('Kitkat.lua')  
end
if text == 'الاصدار✟︙' and DevKitkatW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✟︙اصدار سورس كيت كات\n✟︙الاصدار »{ 1.5v}')
end
if text == 'قناه تحديثات البوت✟︙' and DevKitkatW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✟︙[تحديثات البوت](t.me/GXKXG) \n✟︙[قناه السورس](t.me/tsss2018)')
end
if text == "ضع اسم للبوت✟︙" and DevKitkatW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات✟︙' and DevKitkatW(msg) then 
...
if text == 'المشتركين✟︙' and DevKitkatW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✟︙المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات✟︙' and DevKitkatW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✟︙الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين✟︙") and DevKitkatW(msg) then
...
if text == ("قائمه العام✟︙") and DevKitkatW(msg) then
...
if text == ("قائمه الكتم العام✟︙") and DevKitkatW(msg) then
...
if text=="اذاعه خاص✟︙" and msg.reply_to_message_id_ == 0 and DevKitkatW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل الان اذاعتك؟ \n✟︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه✟︙" and msg.reply_to_message_id_ == 0 and DevKitkatW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل الان اذاعتك؟ \n✟︙للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت✟︙" and msg.reply_to_message_id_ == 0 and DevKitkatW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل الان اذاعتك؟ \n✟︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه✟︙" and msg.reply_to_message_id_ == 0  and DevKitkatW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص✟︙" and msg.reply_to_message_id_ == 0  and DevKitkatW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✟︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه✟︙' and DevKitkatW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين✟︙" and DevKitkatW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات✟︙" and DevKitkatW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✟︙ عدد الكروبات الان » { '..#group..' }'..Kitkatk..''..Kitkat..'\n✟︙ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKitkatW(msg) then
...
usertext = '\n✟︙العضو » ['..result.title_..'](t.me/'..(username or 'tsss2018')..')'
status  = '\n✟︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevKitkatW(msg) then
...
usertext = '\n✟︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
status  = '\n✟︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKitkatW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKitkatW(msg) then
...
local Kitkat1_Msg = database:get(bot_id.."Kitkat1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Kitkat1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✟︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'tsss2018')..') \n✟︙'..Kitkat1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Kitkat_Msg and not Special(msg) then  
local Kitkat_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Kitkat_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"✟︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✟︙["..Kitkat_Msg.."] \n")
else
send(msg.chat_id_,0,"✟︙العضو : {["..data.first_name_.."](t.me/tsss2018)}\n✟︙["..Kitkat_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✟︙عذرا » {["..data.first_name_.."](t.me/tsss2018)}\n✟︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKitkatW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKitkatW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKitkatW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✟︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKitkatW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✟︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك✟︙" and DevKitkatW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✟︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك✟︙$") and DevKitkatW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✟︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري✟︙" and DevKitkatW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري✟︙" and DevKitkatW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "✟︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري✟︙" and DevKitkatW(msg) then  
...
database:sadd(bot_id.."Kitkat:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Kitkat:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Kitkat = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Kitkat then 
names_Kitkat = database:smembers(bot_id.."Kitkat:blocname"..msg.chat_id_) or ""
if names_Kitkat and names_Kitkat[1] then 
for i=1,#names_Kitkat do 
if name_Kitkat:match("(.*)("..names_Kitkat[i]..")(.*)") then 
...
database:set(bot_id.."Kitkat:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Kitkat:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Kitkat:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Kitkat:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Kitkat:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Kitkata_new(Kitkat1,Kitkat2)
if Kitkat2 and Kitkat2.first_name_ then 
if Kitkat2.first_name_:match("(.*)"..database:get(bot_id.."Kitkat:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Kitkat:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Kitkat_nnn = database:get(bot_id.."Kitkat:nump"..msg.chat_id_) or 5
local Kitkat_nnn2 = database:get(bot_id.."Kitkat:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Kitkat_nnn2) == tonumber(Kitkat_nnn) or tonumber(Kitkat_nnn2) > tonumber(Kitkat_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Kitkat:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✟︙عزيزي >>["..Kitkat2.username_.."](https://t.me/"..(Kitkat2.username_ or "tsss2018")..")\n✟︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Kitkat:teh"..msg.chat_id_).."} بجانب اسمك\n✟︙عدد المحاولات المتبقيه {"..(tonumber(Kitkat_nnn) - tonumber(Kitkat_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Kitkata_new)
end
end
...
local KitkatChengName = database:get(bot_id.."Kitkat:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KitkatChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KitkatChengName..']')
database:del(bot_id.."Kitkat:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KitkatChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Kitkat:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KitkatChengUserName = database:get(bot_id.."Kitkat:Cheng:UserName"..data.id_)
if not data.username_ then 
if KitkatChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KitkatChengUserName..']')
database:del(bot_id.."Kitkat:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KitkatChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Kitkat:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KitkatChengPhoto = database:get(bot_id.."Kitkat:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KitkatChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Kitkat:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KitkatChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Kitkat:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevKitkatW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✟︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'tsss2018')..') \n✟︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✟︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'tsss2018')..') \n✟︙تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevKitkatW(msg) then    
dofile('Kitkat.lua')  
send(msg.chat_id_, msg.id_, '✟︙تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevKitkatW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKitkatW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevKitkatW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevKitkatW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKitkatW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevKitkatW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevKitkatW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKitkatW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevKitkatW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevKitkatW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevKitkatW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKitkatW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKitkatW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "tsss2018")
...
function Function_Kitkat(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Kitkat, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Kitkat, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✟︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
status  = '\n✟︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✟︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✟︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
...
database:set(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"✟︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Kitkat1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Kitkat1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"✟︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Kitkat1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Kitkat1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Kitkat1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"✟︙ارسل الكلمه الان")  
database:set(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Kitkat1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Kitkat1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Kitkat1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Kitkat1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Kitkat1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Kitkat1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n✟︙قائمة المنع \n⍆══•═══KT══•═══⍅\n"
for k,v in pairs(list) do  
local Kitkat_Msg = database:get(bot_id.."Kitkat1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Kitkat_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevKitkatW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✟︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevKitkatW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✟︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'tsss2018')..')'..'\n✟︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKitkatW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKitkatW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Kitkat_Msg[math.random(#Kitkat_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKitkatW(msg) then 
...
if text == ("مسح ردود المطور") and DevKitkatW(msg) then 
...
if text == ("ردود المطور") and DevKitkatW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n✟︙قائمة ردود المطور \n⍆══•═══KT══•═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKitkatW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevKitkatW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevKitkatW(msg) then   
...
if text == 'تعطيل المغادره' and DevKitkatW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✟︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Kitkat')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Kitkatdx(msg.chat_id_, msg.id_, '✟︙ايدي المجموعة » ( '..msg.chat_id_..' )\n✟︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n✟︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n✟︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKitkatW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ ✟︙⍆══•═══KT══•═══⍅ ✟︙○ٴ\n✟︙彡 .[𝘽??𝘼??𝘿 𝙏𝙀𝘼𝙈](t.me/tsss2018)➢ ')
end
...
Kitkat = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Kitkat)
...
--------------------------------------------------------------------------------------------------------------
SourceKitkat(data.message_,data)
...
------------------------------------------------------------------------
local KitkatAbot = database:get(bot_id.."Kitkat1:Add:Filter:Rp2"..text..result.chat_id_)   
if KitkatAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"✟︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✟︙["..KitkatAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Kitkat1_Msg = database:get(bot_id.."Kitkat1:Add:Filter:Rp2"..text..result.chat_id_)   
if Kitkat1_Msg then    
send(msg.chat_id_, msg.id_,"✟︙"..Kitkat1_Msg)
